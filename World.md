...
Players uncover new areas through travel, quests, map skills, rumours, visible landmarks, and environmental clues. Biome-specific challenges encourage adaptive strategies, while hidden lore and environmental storytelling reward careful observation. The express routes, portals, mounts, sailing, climbing, and flight of [Travel and Mounts](Travel-and-mounts.md) can unlock more advanced access later in progression, but they should expand the value of travel rather than erase it.

## World Feel

The world should feel alive. Wildlife reacts to danger and player presence, NPC settlements maintain routines and trade routes, the [weather, time, and seasons](Weather-time-and-seasons.md) affect combat and travel, and landmarks create memorable orientation points. Whether a player is climbing summits, sailing stormy seas, crossing dense forest, or exploring floating islands, the world should feel rich, cohesive, and full of possibility.
